...
export const EXTENSION_MODEL_CHAIN = {
  ...
  seniorReview: ["bmind/openai/gpt-oss-20b", "omniroute/auto/claude-opus", "unikey/claude-opus-4-8", "browseruse/claude-fable-5"],
  // Alias retained for callers that identify the senior pass as review #2.
  secondReview: ["bmind/openai/gpt-oss-20b", "omniroute/auto/claude-opus", "unikey/claude-opus-4-8", "browseruse/claude-fable-5"],
} as const;
