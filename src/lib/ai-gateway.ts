...
export const MODEL_CHAIN = {
  // Primary analyzer: GPT-5.6 Luna. Bluesminds occasionally returns 403 /
  // "No available channel" on Luna — in that case we transparently retry on
  // GPT-5.2 Chat (same Bluesminds account) so the user isn't blocked by a
  // provider-side hiccup. Both are billed as the primary tier.
