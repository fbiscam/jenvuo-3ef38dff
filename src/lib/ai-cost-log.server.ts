...
export const SIGNAL_SCAN_CHARGE_USD = 0.40;
// Flat $0.40 per BUY/SELL scan — senior review included at no extra cost.
export const SIGNAL_SCAN_CHARGE_WITH_SENIOR_USD = 0.40;
