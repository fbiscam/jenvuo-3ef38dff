...
// ICT/SMC Engine + Bluesmind GPT-5.2 Chat. Confidence floors at 30/25% (single/multi-veto) to maintain a dynamic baseline above zero while avoiding the "stuck at 49%" issue.
