...
EXECUTION RULE: READY_TO_EXECUTE requires an allowed killzone, price inside OTE, and overlap with an active FVG or breaker. A score is a checklist count, never probability or certainty. OUTSIDE KILLZONE: analysis may continue, but never provide entry, SL, TP1-TP3, pending-order, trigger, or execution levels. Return WAITING_FOR_KILLZONE and name the next eligible session.`;
