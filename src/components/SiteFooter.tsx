            ...
            <div className="flex items-center gap-2.5 pt-1">
              {[
                ...
                },
                {
                  ...
                  icon: (
                    <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
                      <path d="M12 2.163c3.204 0 3.584.012 4.849.07 1.366.062 2.633.334 3.608 1.309.975.975 1.247 2.242 1.309 3.608.058 1.265.07 1.645.07 4.849s-.012 3.584-.07 4.849c-.062 1.366-.334 2.633-1.309 3.608-.975.975-2.242 1.247-3.608 1.309-1.265.058-1.645.07-4.849.07s-3.584-.012-4.849-.07c-1.366-.062-2.633-.334-3.608-1.309-.975-.975-1.247-2.242-1.309-3.608C2.175 15.647 2.163 15.267 2.163 12s.012-3.584.07-4.849c.062-1.366.334-2.633 1.309-3.608.975-.975 2.242-1.247 3.608-1.309C8.416 2.175 8.796 2.163 12 2.163Zm0 1.802c-3.148 0-3.51.012-4.75.068-1.02.047-1.573.216-1.94.359-.487.19-.835.416-1.2.781-.365.365-.591.713-.781 1.2-.143.367-.312.92-.359 1.94-.056 1.24-.068 1.602-.068 4.75s.012 3.51.068 4.75c.047 1.02.216 1.573.359 1.94.19.487.416.835.781 1.2.365.365.713.591 1.2.781.367.143.92.312 1.94.359 1.24.056 1.602.068 4.75.068s3.51-.012 4.75-.068c1.02-.047 1.573-.216 1.94-.359.487-.19.835-.416 1.2-.781.365-.365.591-.713.781-1.2.143-.367.312-.92.359-1.94.056-1.24.068-1.602.068-4.75s-.012-3.51-.068-4.75c-.047-1.02-.216-1.573-.359-1.94-.19-.487-.416-.835-.781-1.2-.365-.365-.713-.591-1.2-.781-.367-.143-.92-.312-1.94-.359-1.24-.056-1.602-.068-4.75-.068Zm0 3.064a5.135 5.135 0 1 1 0 10.27 5.135 5.135 0 0 1 0-10.27Zm0 8.468a3.333 3.333 0 1 0 0-6.666 3.333 3.333 0 0 0 0 6.666Zm5.338-8.669a1.2 1.2 0 1 1 0-2.4 1.2 1.2 0 0 1 0 2.4Z" />
                    </svg>
                  ),
                },
                {
