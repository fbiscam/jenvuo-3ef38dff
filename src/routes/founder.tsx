...
const FOUNDING_STORY = {
  ...
  bio: [
    ...
    "He spent years dissecting ICT, SMC, liquidity engineering and market structure specifically on XAU/USD. The patterns were repeatable, but the execution tools were fragmented. So he built the chart extension he wished he had at 18 — AI-augmented and ruthlessly honest about risk.",
      ...
      <section className="rounded-xl bg-white p-6 sm:p-10 text-zinc-900 border border-zinc-200">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-zinc-600">
            Join the desk Haseeb built. 30 days of selected-plan access, included scan credits, and no card required.
          </p>
