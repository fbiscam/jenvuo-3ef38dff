...
function Home() {
  ...
  return (
    <div className={cn("fixed inset-0 h-[100dvh] w-screen relative overflow-hidden overscroll-none flex flex-col transition-colors duration-300", dark ? "bg-neutral-950 text-neutral-100" : "bg-white text-neutral-900")} style={{ touchAction: "none" }}>
      {/* Header */}
