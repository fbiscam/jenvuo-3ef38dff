        ...
        <div className="grid gap-8 sm:gap-10 lg:grid-cols-12 lg:items-end">
          <div className="text-left lg:col-span-7 lg:text-left">
            ...
            <p className="mt-5 max-w-3xl text-[13px] leading-relaxed text-zinc-900 sm:text-base md:text-lg lg:mx-0">
              <span className="sm:hidden">Voice-native gold desk narrating live A+ ICT/SMC setups across every XAU pair.</span>
              <span className="hidden sm:inline">Voice-native gold terminal narrating live A+ ICT/SMC setups across every XAU pair in real time with institutional precision.</span>
            </p>
      ...
      <section className="relative border-t border-zinc-100 bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 pt-14 pb-16">
          ...
          <div className="mt-10 grid gap-4 sm:hidden">
            {[
              { name: "Free", key: "free", price: "$0", tag: "Curious", to: "/auth" as const, cta: "Start free", credits: "$2 wallet", bullets: ["Unlimited voice queries (free)", "4h delayed alerts", "Community support"] },
