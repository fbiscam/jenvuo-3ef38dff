    ...
    <div className={`jenvu-zoom min-h-dvh w-full bg-[#FAFAFA] text-zinc-900 ${SANS} antialiased selection:bg-zinc-900 selection:text-white`}>
      ...
      <section className="relative border-t border-zinc-100 bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 pt-14 pb-16">
          ...
          {/* Footer strip */}
          <div className="mt-4 sm:mt-12 flex flex-col items-center justify-center gap-4 rounded-2xl border border-zinc-200 bg-white px-6 py-5 sm:flex-row sm:justify-between sm:items-start">
            <div />
