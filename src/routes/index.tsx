    ...
    <div className={`jenvu-zoom min-h-dvh w-full bg-[#FAFAFA] text-zinc-900 ${SANS} antialiased selection:bg-zinc-900 selection:text-white`}>
      ...
      <section className="relative border-t border-zinc-100 bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 pt-14 pb-16">
              ...
              <thead>
                <tr className="border-b border-zinc-200">
                  ...
                  {[
                    ...
                    { name: "Ultra", key: "ultra", price: "$100", tag: "Fund / Desk+", to: "/contact" as const, cta: "Talk to sales", dark: false },
                  ].map((p) => {
                    const isCurrent = currentPlan === p.key;
                    return (
                    <th
                          ...
                          <span className="inline-flex flex-col items-center justify-center gap-1">
                            <span className="inline-flex flex-col sm:flex-row flex-nowrap items-center justify-center gap-1 whitespace-nowrap">
                              <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1.5 py-0.5">
                                ...
                                <span className="text-[10px] font-medium text-zinc-800 whitespace-nowrap">GPT-5.4</span>
                              </span>
                              {v === "__MODELS_PLUS__" && (
                                <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1.5 py-0.5">
                                  <img src={xaiLogo} width={10} height={10} alt="xAI" className="object-contain" />
                                  <span className="text-[10px] font-medium text-zinc-800 whitespace-nowrap">Grok 4.5</span>
                                </span>
                              )}
                            </span>
                            {(v === "__MODELS__" || v === "__MODELS_PLUS__") && (
                              <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1.5 py-0.5">
                                ...
                                <span className="text-[10px] font-medium text-zinc-800 whitespace-nowrap">DeepSeek V4 Pro</span>
                              </span>
                            )}
                          </span>
                        ) : (
          ...
          {/* Footer strip */}
          <div className="mt-12 hidden sm:flex flex-col items-center justify-center gap-4 rounded-2xl border border-zinc-200 bg-white px-6 py-5 sm:flex-row sm:justify-between sm:items-start">
            <div />
