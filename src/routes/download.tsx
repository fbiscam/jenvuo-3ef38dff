  ...
  head: () => ({
    meta: [
      { title: "Download our app" },
      {
        name: "description",
        content:
          "Get Jenvu on your device. Use the AI-powered gold analysis terminal with ICT/SMC chart context, reviewed signals and live alerts.",
      },
      { property: "og:title", content: "Download our app" },
      {
        property: "og:description",
        content:
          "Access Jenvu across desktop and mobile, with the built-in trading terminal at the center of your ICT/SMC workflow.",
      },
...
const PLATFORMS: Platform[] = [
  {
    ...
    label: "iOS",
    channel: "App Store",
    blurb: "Native iPhone & iPad companion. Push alerts and haptics keep terminal signals close when you leave your desk.",
    status: "COMING SOON",
...
const CHANGELOG = [
  { v: "v1.0.0", t: "Initial release", body: "built-in trading terminal, signal engine, ICT/SMC analyzer and live A+ setup grading." },
      ...
      <div className={`public-cloudflare jenvu-zoom min-h-dvh w-full bg-background text-foreground ${SANS} antialiased selection:bg-home-accent selection:text-home-accent-foreground`}>
        ...
        <section className="public-page-hero mx-auto max-w-6xl px-5 pb-10 pt-12 sm:px-6 sm:pb-14 sm:pt-16">
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-zinc-900 md:text-lg">
            <span className="sm:hidden">Jenvu on iOS, Android and desktop — same terminal signals, same institutional engine, same A+ setups. Links coming soon.</span>
            <span className="hidden sm:inline">Jenvu on iOS, Android and desktop with the same terminal signals, institutional engine and A+ setups. Download links are being prepared shortly.</span>
          </p>
        </section>
