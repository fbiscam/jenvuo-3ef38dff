    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Voice-native institutional AI trading terminal for Gold, Crypto, FX and Indices — available on iOS, Android and as an installable PWA.",
    ...
    <>
      ...
      <div className={`jenvu-zoom min-h-dvh w-full bg-white text-zinc-900 ${SANS} antialiased selection:bg-zinc-900 selection:text-white`}>
        ...
        <section className="mx-auto max-w-6xl px-5 pt-12 pb-10 sm:px-6 sm:pt-16 sm:pb-14">
          <h1 className="mt-5 max-w-5xl text-3xl font-semibold tracking-tight leading-[1.15] sm:text-4xl md:text-5xl whitespace-nowrap">
