      ...
      <div className={`jenvu-zoom min-h-dvh bg-white text-zinc-900 ${SANS} antialiased`}>
        ...
        <section className="border-b border-zinc-100 bg-gradient-to-b from-zinc-50 to-white">
          <div className="mx-auto max-w-3xl px-5 sm:px-6 py-16 sm:py-24 text-center">
            <div className={`${MONO} text-[10px] uppercase tracking-[0.28em] text-zinc-500 mb-4`}>
              [ Help Center ]
            </div>
        ...
        {/* CONTACT CTA */}
        <section className="mx-auto max-w-6xl px-5 sm:px-6 py-14 sm:py-20">
          <div className="rounded-2xl border border-zinc-200 bg-zinc-900 text-white p-8 sm:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <div className={`${MONO} text-[10px] uppercase tracking-[0.28em] text-zinc-400`}>
                [ Still stuck? ]
              </div>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 rounded-full bg-white text-zinc-900 px-5 py-3 text-sm font-medium hover:bg-zinc-100 transition"
            >
