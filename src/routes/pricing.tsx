  ...
  return (
    <div className={`min-h-dvh w-full bg-white text-zinc-900 ${SANS} antialiased`} style={{ zoom: 1.25 }}>
      ...
      <section className="mx-auto max-w-6xl px-5 sm:px-6 py-16">
            ...
            return (
              <article
                ...
                className={`relative rounded-3xl border p-7 transition ${
                  t.highlight
                    ? "border-zinc-900 bg-zinc-900 text-white shadow-[0_30px_80px_-20px_rgba(0,0,0,0.45)] md:scale-[1.03]"
                    : "border-zinc-200 bg-white hover:shadow-[0_20px_60px_-30px_rgba(0,0,0,0.2)]"
                }`}
              >
                {t.highlight && (
                  <>
                    <div
                      aria-hidden
                      className="pointer-events-none absolute -inset-px rounded-3xl opacity-30 blur-2xl"
                      style={{
                        background:
                ...
                <div className="relative">
                  ...
                  <p className={`mt-2 text-sm ${t.highlight ? "text-zinc-400" : "text-zinc-500"}`}>{t.tagline}</p>
        ...
        <p className={`mt-8 text-center ${MONO} text-[10px] uppercase tracking-[0.25em] text-zinc-400`}>
