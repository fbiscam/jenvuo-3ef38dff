  ...
  return (
    <div className={`min-h-dvh w-full bg-[#FAFAFA] text-zinc-900 ${SANS} antialiased`}>
      <main className="mx-auto max-w-7xl px-5 py-8 sm:px-6 sm:py-10">
        {/* Header card */}
        <div className="rounded-xl border border-zinc-200 bg-white p-5 ring-1 ring-white/60 sm:p-6">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {TILES.map((t) => (
              <button
                ...
                type="button"
                onClick={() => setActive(t)}
                className="group flex flex-col rounded-xl border border-zinc-200 bg-white p-5 text-left ring-1 ring-white/60 transition-all duration-300 hover:-translate-y-1 hover:border-zinc-300/70"
              >
