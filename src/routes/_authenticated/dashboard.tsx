    ...
    <div className="flex bg-white text-zinc-900 font-['Google_Sans','Product_Sans','Poppins',system-ui,sans-serif] antialiased jenvu-zoom-dashboard">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-5 pt-14 pb-7 sm:px-8 sm:pt-7">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1.5 text-[12px] text-zinc-500" style={{ fontFamily: '"Google Sans", "Product Sans", "Roboto", system-ui, sans-serif', fontWeight: 400 }}>
              ...
              >
                <span className="inline-flex items-center gap-1.5 rounded-md border border-zinc-200 bg-white px-1.5 py-1 leading-none hover:bg-zinc-50">
                  <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/openai.svg" alt="OpenAI" width={16} height={16} className="h-[16px] w-[16px] shrink-0 object-contain" loading="lazy" />
                  ...
                  {showDeepSeek && (
                    <>
                      ...
                      <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/deepseek.svg" alt="DeepSeek" width={16} height={16} className="h-[16px] w-[16px] shrink-0 object-contain" loading="lazy" />
                      <span className="text-[11px] font-medium leading-none text-zinc-800">DeepSeek</span>
                      <span className="leading-none text-zinc-300">·</span>
                      <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/google.svg" alt="Google" width={16} height={16} className="h-[16px] w-[16px] shrink-0 object-contain" loading="lazy" />
        ...
        <section className="mt-3 grid grid-cols-1 gap-4 lg:grid-cols-3">
          <Card>
            <CardHeader icon={ShieldCheck} title="Wallet & Plan" className="bg-white" />
