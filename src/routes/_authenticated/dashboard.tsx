            ...
            <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1.5 text-[12px] text-zinc-500">
              ...
              >
                <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1 py-0.5 hover:bg-zinc-50 sm:px-1.5">
                  ...
                  <span className="text-[10px] font-medium text-zinc-800 sm:text-[11px]">GPT-5 Mini</span>
                </span>
                {showDeepSeek && (
                <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1 py-0.5 hover:bg-zinc-50 sm:px-1.5">
                  ...
                  <span className="text-[10px] font-medium text-zinc-800 sm:text-[11px]">Claude 4.5 + Gemini 2.5 Pro</span>
                </span>
                )}
              </Link>
            </div>
