  ...
  if (alerts.length === 0) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-8 text-center">
        ...
        <p className="mt-1 max-w-[260px] text-[12px] text-zinc-500">The engine runs every 15 minutes. Senior-confirmed setups will land here automatically.</p>
      </div>
    );
  }
  ...
  return (
    <div className={`flex min-h-screen bg-white text-zinc-900 font-['Google_Sans','Product_Sans','Poppins',system-ui,sans-serif] antialiased jenvu-zoom-dashboard`}>
      ...
      >
        ...
        {/* Brand */}
        <div className={`flex h-11 shrink-0 items-center gap-2.5 bg-sidebar ${sidebarCollapsed ? "justify-center px-2" : "px-4"}`}>
        ...
        <div className={`mt-auto shrink-0 flex items-center border-t border-zinc-200 bg-sidebar py-2 ${sidebarCollapsed ? "justify-center px-2" : "justify-between pl-3 pr-2"}`}>
          {!sidebarCollapsed && (
            <button
              type="button"
              onClick={signOut}
        ...
        {banner.variant === "features" ? (
          ...
          <div className="relative min-h-[180px] overflow-hidden rounded-lg border border-border bg-primary text-primary-foreground sm:min-h-[190px]">
            ...
            <div className="relative z-10 flex min-h-[180px] max-w-3xl flex-col justify-center px-7 py-5 sm:min-h-[190px] sm:px-9">
              <h2 className="dashboard-model-banner-heading text-xl font-semibold sm:text-2xl">{banner.eyebrow}</h2>
    ...
    <section className="mt-10 bg-background" aria-label="Models and product updates">
      <div className="mx-auto grid w-full max-w-6xl gap-9 lg:grid-cols-[minmax(0,1.7fr)_minmax(260px,0.9fr)] lg:gap-10">
                ...
                >
                  ...
                  <div className="relative z-10 flex h-full flex-col">
                    <div className="flex items-start justify-between gap-3">
                      <div className={`flex h-11 items-center gap-2 rounded-md border px-2.5 ${model.featured ? "border-primary-foreground/30 bg-foreground" : "border-border bg-background"}`} aria-label={`${model.logoLabel || model.name} model`}>
                        {model.logoImage ? (
        ...
        <aside className="min-w-0">
          <h2 className="mb-4 pl-[58px] text-2xl font-normal text-foreground">         Latest updates</h2>
