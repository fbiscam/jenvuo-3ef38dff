            ...
            <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1.5 text-[12px] text-white/70" style={{ fontFamily: '"Google Sans", "Product Sans", "Roboto", system-ui, sans-serif', fontWeight: 400 }}>
              ...
              >
                <span className="inline-flex items-center gap-1.5 rounded-md bg-transparent px-1.5 py-1 leading-none">
                  <img src="https://www.google.com/s2/favicons?domain=openai.com&sz=64" alt="OpenAI" width={16} height={16} className="h-[16px] w-[16px] shrink-0 object-contain" style={{ filter: "brightness(0) invert(1)" }} loading="lazy" />
                  <span className="text-[11px] font-medium leading-none text-white">OpenAI</span>
                  {showDeepSeek && (
                    <>
                      <span className="leading-none text-white/40">·</span>
                      <img src="https://www.google.com/s2/favicons?domain=deepseek.com&sz=64" alt="DeepSeek" width={16} height={16} className="h-[16px] w-[16px] shrink-0 object-contain" style={{ filter: "brightness(0) invert(1)" }} loading="lazy" />
                      <span className="text-[11px] font-medium leading-none text-white">DeepSeek</span>
                      <span className="leading-none text-white/40">·</span>
                      <img src="https://www.google.com/s2/favicons?domain=google.com&sz=64" alt="Google" width={16} height={16} className="h-[16px] w-[16px] shrink-0 object-contain" style={{ filter: "brightness(0) invert(1)" }} loading="lazy" />
