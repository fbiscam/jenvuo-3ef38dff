      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-5 pt-14 pb-7 sm:px-8 sm:pt-7">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 lg:items-end" style={{ fontFamily: '"Google Sans", "Product Sans", "Roboto", system-ui, sans-serif', fontWeight: 400 }}>
          ...
          <div className="flex items-center gap-1.5 lg:self-end lg:mt-8 lg:mb-0">
            ...
            <Link
              to="/app"
              className="inline-flex items-center gap-1.5 rounded-md border border-zinc-200 bg-white px-1.5 py-1 leading-none text-zinc-900 hover:bg-zinc-50"
            >
              <Plus className="h-[14px] w-[14px]" />
              <span className="text-[11px] font-medium leading-none">Launch AI</span>
            </Link>
          </div>
        </div>
