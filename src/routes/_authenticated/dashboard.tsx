      ...
      <main className="mx-auto w-full max-w-7xl px-5 py-7 sm:px-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 lg:items-end">
          <div className="min-w-0">
            ...
            <h1 className="mt-1 truncate text-[16px] tracking-tight text-zinc-900 sm:text-[30px]" style={{ fontFamily: '"Inter Variable", "Inter", ui-sans-serif, system-ui, sans-serif', fontWeight: 400 }}>
              <span style={{ fontFamily: '"Urbanist", sans-serif', fontWeight: 500 }}>{email || fullName}</span><span className="text-zinc-500">'s Account</span>
            </h1>
