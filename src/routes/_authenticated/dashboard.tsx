          ...
          <div className="min-w-0">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2 text-[12px] text-zinc-500">
              ...
              >
                ...
                <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1.5 py-0.5 hover:bg-zinc-50">
                  <svg viewBox="0 0 24 24" width="10" height="10" aria-hidden="true"><defs><linearGradient id="gemgrad" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#4285F4"/><stop offset="0.5" stopColor="#9B72F2"/><stop offset="1" stopColor="#D96570"/></linearGradient></defs><path fill="url(#gemgrad)" d="M12 2c.4 4.6 3.4 7.6 8 8-4.6.4-7.6 3.4-8 8-.4-4.6-3.4-7.6-8-8 4.6-.4 7.6-3.4 8-8z"/></svg>
