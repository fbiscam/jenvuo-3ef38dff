      ...
      <main className="mx-auto w-full max-w-7xl flex-1 bg-white px-5 pt-14 pb-7 sm:px-8 sm:pt-7">
        ...
        <div className="space-y-1" style={{ fontFamily: '"Google Sans", "Product Sans", "Roboto", system-ui, sans-serif', fontWeight: 400 }}>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger
                className="mr-8 hidden sm:flex items-center justify-center overflow-hidden rounded-full focus:outline-none focus:ring-2 focus:ring-zinc-300"
              ...
              >
                <img
                  ...
                  className="h-[56px] w-[56px] rounded-full object-cover [image-rendering:-webkit-optimize-contrast]"
                  loading="eager"
                  decoding="async"
                />
              </DropdownMenuTrigger>
