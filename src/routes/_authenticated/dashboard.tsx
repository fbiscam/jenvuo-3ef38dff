                  ...
                  return (
                    ...
                    >
                      ...
                      {!sidebarCollapsed && typeof count === "number" && count > 0 && !active && (
                        <span className="ml-auto inline-flex shrink-0 items-center justify-center rounded-full bg-rose-600 text-white tabular-nums ring-2 ring-white" style={{ height: 20, width: 20, minWidth: 20, fontSize: 10, lineHeight: '20px', fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 600, letterSpacing: "-0.02em", textAlign: 'center' }}>
                          {count}
                        </span>
                      )}
            ...
            <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1.5 text-[12px] text-zinc-500" style={{ fontFamily: '"Google Sans", "Product Sans", "Roboto", system-ui, sans-serif', fontWeight: 400 }}>
              ...
              >
                <span className="inline-flex items-center gap-1.5 rounded-md border border-zinc-200 bg-white px-1.5 py-1 leading-none hover:bg-zinc-50">
                  <img src="https://www.google.com/s2/favicons?domain=openai.com&sz=64" alt="OpenAI" width={18} height={18} className="h-[18px] w-[18px] shrink-0 rounded-sm object-contain" loading="lazy" />
