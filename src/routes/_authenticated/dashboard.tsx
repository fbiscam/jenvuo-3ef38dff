      ...
      >
        ...
        <div className={`flex h-14 shrink-0 items-center gap-2.5 ${sidebarCollapsed ? "justify-center px-2" : "px-4"}`}>
          <Link to="/" className="flex items-center gap-2.5 min-w-0">
            ...
            {!sidebarCollapsed && (
              <span className="truncate text-[22px] font-bold tracking-tight leading-none" style={{ color: "#5e5e5e" }}>Jenvu</span>
            )}
          </Link>
          <button
            type="button"
                ...
                {group.items.map((t) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`group relative flex items-center rounded-md text-[14px] font-medium transition
