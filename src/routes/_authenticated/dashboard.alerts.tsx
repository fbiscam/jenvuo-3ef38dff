              ...
              {ALL_GRADES.map((g) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-md px-3 py-1.5 text-xs font-semibold transition border ${on ? "bg-emerald-600 text-white border-emerald-600" : "bg-white text-zinc-500 border-zinc-200 hover:bg-zinc-50"}`}
                  >
                    {g}
                  </button>
                );
