        ...
        <div className="mt-5 space-y-3">
          ...
          <div className="rounded-xl border border-zinc-100 p-3">
            ...
            <a
              ...
              className="mt-3 inline-flex items-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-xs font-semibold text-zinc-900 hover:bg-zinc-50"
            >
