    ...
    <div className="max-w-6xl space-y-6">
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-4 sm:p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-base font-semibold text-black normal-case pl-1">Recent alerts</h2>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6">
        <h2 className="pl-1 text-base font-semibold text-black normal-case">Delivery channels</h2>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6">
        <h2 className="pl-1 text-base font-semibold text-black normal-case">Conviction filter</h2>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6">
        <h2 className="pl-1 text-base font-semibold text-black normal-case">Alert filters</h2>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6">
        <h2 className="pl-1 text-base font-semibold text-black normal-case">Quiet hours</h2>
