        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <div className="mt-2 flex items-baseline gap-2 flex-nowrap whitespace-nowrap">
              ...
              <span className="text-[11px] sm:text-sm text-zinc-500">/ ${Number(credits.allowance).toFixed(2)} · {plan.toUpperCase()} /Free credits</span>
            </div>
            {resetsAt && (
                        ...
                        {v === true ? (
                          ...
                          <span className="inline-flex flex-col items-center justify-center gap-1"><span className="inline-flex flex-col sm:flex-row flex-nowrap items-center justify-center gap-1 whitespace-nowrap">
                            <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1.5 py-0.5">
                              ...
                              <span className="text-[10px] font-medium text-zinc-800">OpenAI</span>
                            </span>
                            </span>
