      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 sm:p-8" style={{ fontFamily: '"Google Sans", "Product Sans", "Roboto", system-ui, sans-serif', fontWeight: 400, textTransform: "none", letterSpacing: "normal" }}>
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-[12.5px] text-zinc-500">Flat $0.20 per real BUY/SELL signal, or $0.25 when DeepSeek senior review is required. WAIT / no-trade scans are free.</p>
          </div>
                    ...
                    return (
                      ...
                      >
                        {v === true ? (
                          ...
                          <span className="inline-flex flex-col items-center justify-center gap-1"><span className="inline-flex flex-col sm:flex-row flex-nowrap items-center justify-center gap-1 whitespace-nowrap">
                            <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1.5 py-0.5">
                              ...
                              <span className="text-[10px] font-medium text-zinc-800">GPT-5 Mini</span>
                            </span>
                            </span>
                            {(v === "__MODELS__" || v === "__MODELS_PLUS__") && (
                              <span className="inline-flex items-center gap-1 rounded-md border border-zinc-200 bg-white px-1.5 py-0.5">
                                ...
                                <span className="text-[10px] font-medium text-zinc-800 whitespace-nowrap">Claude 4.5 + Gemini 2.5 Pro</span>
                              </span>
                            )}
                          </span>
                        ) : (
