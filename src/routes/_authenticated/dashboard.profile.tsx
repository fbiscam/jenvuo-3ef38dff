  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6">
        ...
        <p className="mt-1 text-sm text-zinc-500">Send yourself a password reset link.</p>
        <button onClick={sendPasswordReset} className="mt-4 rounded-lg border border-zinc-200 px-4 py-2 text-sm font-medium hover:bg-zinc-50">
          Send password reset
        </button>
      </section>
