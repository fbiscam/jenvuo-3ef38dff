...
function ReferralsPage() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: "Join me on Jenvu. Use my link to get $1 bonus wallet credit when you upgrade.",
          url: info.shareUrl,
        });
  ...
  const submitCode = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success("Referral applied. You'll earn $1 bonus wallet credit when you upgrade to a paid plan.");
        setCodeInput("");
        await load();
      } else {
    ...
    <div className="mx-auto max-w-5xl px-4 py-8 space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">
          ...
          <span className="font-medium text-emerald-600">$1 bonus wallet credit</span> each.
        </p>
      </div>
      ...
      {!info.incoming && (
        <div className="rounded-xl border border-zinc-200 bg-white p-5">
          ...
          <p className="mt-1 text-xs text-zinc-500">
            Enter it before upgrading to earn $1 bonus wallet credit.
          </p>
      ...
      {info.incoming && (
        <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900">
          {info.incoming.status === "converted" ? (
            ...
            <>A referral is attached to your account. Upgrade to Pro, Elite, or Ultra to unlock your $1 bonus wallet credit.{" "}
