...
export const Route = createFileRoute("/help/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Jenvu AI Help Center — guides and troubleshooting for the built-in trading terminal, ICT/SMC signal engine, billing and account security." },
