    ...
    <div className="signal-page-root min-h-dvh w-full bg-[#FAFAFA] text-slate-900 antialiased" style={{ fontFamily: '"Google Sans", "Product Sans", "Roboto", system-ui, sans-serif', fontWeight: 400 }}>
      ...
      {!credits.isLoading && (!credits.features.realtime_alerts || !credits.features.full_ict) && (
        <div className="border-b border-amber-100 bg-amber-50/70">
          <div className="mx-auto max-w-[1600px] px-5 py-2 sm:px-6 flex flex-wrap items-center justify-between gap-2 text-[11px] text-amber-900" style={{ fontFamily: '"Google Sans", "Google Sans Text", system-ui, -apple-system, sans-serif' }}>
            <div className="flex items-center gap-2">
