  ...
  public: {
    Tables: {
      ...
      tool_lead_searches: {
        ...
        Relationships: [
          {
            foreignKeyName: "tool_lead_searches_tool_user_id_fkey"
            columns: ["tool_user_id"]
            isOneToOne: false
            referencedRelation: "tool_users"
            referencedColumns: ["id"]
          },
        ]
      }
      tool_user_credit_log: {
        Row: {
          balance_after: number
          created_at: string
          delta: number
        ...
        Relationships: [
          {
            foreignKeyName: "tool_user_credit_log_tool_user_id_fkey"
            columns: ["tool_user_id"]
            isOneToOne: false
            referencedRelation: "tool_users"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      cancel_user_plan: { Args: { _user_id: string }; Returns: Json }
